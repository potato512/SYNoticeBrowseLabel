...
//    label.backgroundColor = [UIColor colorWithWhite:0.5 alpha:0.3];
    ...
    //
    [self.array addObject:noticeLabel];
    ...
    noticeLabel2.texts = @[@"自定义跑马灯功能类标签。"];
    ...
    //
    [self.array addObject:noticeLabel2];
    ...
    noticeLabel3.texts = @[@"106岁老人一年喝200斤包谷酒，唱山歌15分钟停不下来。" ];
    ...
    //
    [self.array addObject:noticeLabel3];
    ...
    noticeLabel4.texts = @[@"男子买到过期食品获索赔，刚出超市便遭围殴！店长：我不是第一次看见他了..." ];
    ...
    //
    [self.array addObject:noticeLabel4];
    ...
    noticeLabel5.texts = @[@"6月份卖得最烂的SUV都在这里了"];
    noticeLabel5.delayTime = 3.0;
    [noticeLabel5 textAnimation:2.0];
    [noticeLabel5 reloadData];
    //
    [self.array addObject:noticeLabel5];
    ...
    noticeLabel6.texts = @[@"汽车库存成灾！汽车下乡或将重启，优惠是真的很大，你买账吗？"];
    noticeLabel6.delayTime = 3.0;
    [noticeLabel6 textAnimation:3.0];
    [noticeLabel6 reloadData];
    //
    [self.array addObject:noticeLabel6];
}
