#
#  Be sure to run `pod spec lint SYNoticeBrowseLabel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "derZhang"
  # s.authors            = { "derZhang" => "zhangsy757@163.com" }
  # s.social_media_url   = "http://twitter.com/derZhang"
